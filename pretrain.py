...
# TODO see this repo for SimMIM implementation and MAE implementation
#  https://github.com/lucidrains/vit-pytorch#3d-vit

# TODO see also https://github.com/sustainlab-group/SatMAE/blob/main/models_mae.py from SatMae

# TODO see also this https://github.com/MCG-NJU/VideoMAE  for VideoMAE
#  in paper they also talk about different masking strategies like random, frame masking and so called tube masking

# https://github.com/facebookresearch/SparseConvNet

# https://github.com/NVIDIA/MinkowskiEngine

# TODO this is best solution for MIM/MAE with convolutions
...
if __name__ == '__main__':
    a = torch.diag(torch.ones((8,))).unsqueeze(0)
    conv = nn.Conv2d(1, 2, 2)
    sconv = SparseConv2d(1, 2, 2)
